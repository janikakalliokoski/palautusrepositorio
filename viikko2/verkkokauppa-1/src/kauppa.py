...
class Kauppa:
    def __init__(self, varasto=the_varasto_olio, pankki=the_pankki_olio, viite_generaattori=the_viitegeneraattori_olio):
        self._varasto = varasto
        self._pankki = pankki
        self._viitegeneraattori = viite_generaattori
